...
<body>
                        ...
                        <table class="table" id="checklist" border="1" style="border-top:2px solid #333!important; border:0px solid #ddd;">
                            ...
                            <tbody id="translist">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_1_1" id="f_1_1_2" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_1_1" id="f_1_1_2" value="0.67"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_1_2" id="f_1_2_2" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_1_2" id="f_1_2_2" value="0.67"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_1_3" id="f_1_3_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_1_3" id="f_1_3_2" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_1_3" id="f_1_3_2" value="0.67"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_1_3_4" id="f_1_3_4" value="0"></center>
                                    </td>
                                    <td>
                                        <textarea name="f_1_3_desc" id="f_1_3_desc" cols="30" rows="2"></textarea>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_2" id="f_2_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <center><input type="text" name="f_2_4" id="f_2_4" value="0"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_3" id="f_3_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_3" id="f_3_2" value="1"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_3" id="f_3_3" value="2"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_3_4" id="f_3_4" value="0"
                                                style="font-weight:bold;"></center>
                                    </td> 
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_4_1" id="f_4_1_3" value="1"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_4_2" id="f_4_2_3" value="1"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <center><input type="text" name="f_5" id="f_5" value="0"
                                                style="font-weight:bold;">
                                        </center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_5_1" id="f_5_1_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_5_1" id="f_5_1_2" value="0.5"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_5_1" id="f_5_1_3" value="1"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_5_1_4" id="f_5_1_4" value="0"></center>
                                    </td>
                                    <td>
                                        <textarea name="f_5_1_desc" id="f_5_1_desc" cols="30" rows="2"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_5_2" id="f_5_2_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_5_2" id="f_5_2_2" value="0.5"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_5_2" id="f_5_2_3" value="1"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_5_2_4" id="f_5_2_4" value="0"></center>
                                    </td>
                                    <td>
                                        <textarea name="f_5_2_desc" id="f_5_2_desc" cols="30" rows="2"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <center><input type="text" name="f_6" id="f_6" value="0"
                                                style="font-weight:bold;">
                                        </center>
                                    </td> 
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_6_1_1" id="f_6_1_1_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_1_1" id="f_6_1_1_2" value="0.17"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_1_1" id="f_6_1_1_3" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_6_1_1_4" id="f_6_1_1_4" value="0"></center>
                                    </td> 
                                    <td>
                                        <textarea name="f_6_1_1_desc" id="f_6_1_1_desc" cols="30" rows="2"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_6_1_2" id="f_6_1_2_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_1_2" id="f_6_1_2_2" value="0.17"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_1_2" id="f_6_1_2_3" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_6_1_2_4" id="f_6_1_2_4" value="0"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_6_2_1" id="f_6_2_1_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_2_1" id="f_6_2_1_2" value="0.17"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_2_1" id="f_6_2_1_3" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_6_2_1_4" id="f_6_2_1_4" value="0"></center>
                                    </td>
                                    <td>
                                        <textarea name="f_6_2_1_desc" id="f_6_2_1_desc" cols="30" rows="2"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_6_2_2" id="f_6_2_2_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_2_2" id="f_6_2_2_2" value="0.17"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_2_2" id="f_6_2_2_3" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_6_2_2_4" id="f_6_2_2_4" value="0"></center>
                                    </td>
                                    <td>
                                        <textarea name="f_6_2_2_desc" id="f_6_2_2_desc" cols="30" rows="2"></textarea>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="width:60%;">6.3.1 Is the proposed infrastructure socially or culturally
                                        ...
                                        0.33)</td>
                                    <td>
                                        <center><input type="radio" name="f_6_3_1" id="f_6_3_1_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_3_1" id="f_6_3_1_2" value="0.17"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_3_1" id="f_6_3_1_3" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_6_3_1_4" id="f_6_3_1_4" value="0"></center>
                                    </td>
                                    <td>
                                        <textarea name="f_6_3_1_desc" id="f_6_3_1_desc" cols="30" rows="2"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_6_3_2" id="f_6_3_2_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_3_2" id="f_6_3_2_2" value="0.17"></center>
                                    </td>
                                    <td>
                                        <center><input type="radio" name="f_6_3_2" id="f_6_3_2_3" value="0.33"></center>
                                    </td>
                                    <td>
                                        <center><input type="text" name="f_6_3_2_4" id="f_6_3_2_4" value="0"></center>
                                    </td>
                                    <td>
                                        <textarea name="f_6_3_2_desc" id="f_6_3_2_desc" cols="30" rows="2"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_7" id="f_7_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <center><input type="text" name="f_7_4" id="f_7_4" value="0"
                                                style="font-weight:bold;"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><input type="radio" name="f_8" id="f_8_1" value="0" checked>
                                        </center>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <center><input type="text" name="f_8_4" id="f_8_4" value="0"
                                                style="font-weight:bold;"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <center><input type="text" name="f_9_4" id="f_9_4" value="0"
                                                style="font-weight:bold;"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <center><input type="text" name="f_10_4" id="f_10_4" value="0"
                                                style="font-weight:bold;"></center>
                                    </td>
                                    <td>
  ...
  $('#checklist').on('click', 'input[type="radio"]', function() {
        ...
        $("#f_6").val(Number($("#f_6_1_4").val()) + Number($("#f_6_2_4").val()) + Number($("#f_6_3_4").val()));
    ...
    $('#submit_evaluation1').on('submit', function() {
        ...
        url = '../php/submit_evalution1_infra.php';
        fetch(url, {
                method: 'post',
                headers: {
