...
<body>
 ...
 <?=$value['f_4_desc']?> 
                    ...
                    <di class="form-group col-md-6">
                        <label for="">Attribution:   Php<?=$value['attribution']?></label>
