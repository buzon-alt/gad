<?php
	...
	$f_1_3 = $_POST['f_1_3']; 
	$f_1_3_4 = $_POST['f_1_3_4']; 
	$f_1_3_desc = $_POST['f_1_3_desc']; 
	$f_2 = $_POST['f_2']; 
	$f_2_4 = $_POST['f_2_4']; 
	...
	$f_5_1 = $_POST['f_5_1']; 
	$f_5_1_4 = $_POST['f_5_1_4']; 
	$f_5_1_desc = $_POST['f_5_1_desc']; 
	$f_5_2 = $_POST['f_5_2']; 
	$f_5_2_4 = $_POST['f_5_2_4']; 
	$f_5_2_desc = $_POST['f_5_2_desc']; 
	$f_6 = $_POST['f_6']; 
	$f_6_desc = $_POST['f_6_desc']; 
	$f_6_1_4 = $_POST['f_6_1_4']; 
	$f_6_1_desc = $_POST['f_6_1_desc']; 
	$f_6_1_1 = $_POST['f_6_1_1']; 
	$f_6_1_1_4 = $_POST['f_6_1_1_4']; 
	$f_6_1_1_desc = $_POST['f_6_1_1_desc']; 
	$f_6_1_2 = $_POST['f_6_1_2']; 
	$f_6_1_2_4 = $_POST['f_6_1_2_4']; 
	$f_6_1_2_desc = $_POST['f_6_1_2_desc']; 
	$f_6_2_4 = $_POST['f_6_2_4']; 
	$f_6_2_desc = $_POST['f_6_2_desc']; 
	$f_6_2_1 = $_POST['f_6_2_1']; 
	$f_6_2_1_4 = $_POST['f_6_2_1_4']; 
	$f_6_2_1_desc = $_POST['f_6_2_1_desc']; 
	$f_6_2_2 = $_POST['f_6_2_2']; 
	$f_6_2_2_4 = $_POST['f_6_2_2_4']; 
	$f_6_2_2_desc = $_POST['f_6_2_2_desc']; 
	$f_6_3_4 = $_POST['f_6_3_4']; 
	$f_6_3_desc = $_POST['f_6_3_desc']; 
	$f_6_3_1 = $_POST['f_6_3_1']; 
	$f_6_3_1_4 = $_POST['f_6_3_1_4']; 
	$f_6_3_1_desc = $_POST['f_6_3_1_desc']; 
	$f_6_3_2 = $_POST['f_6_3_2']; 
	$f_6_3_2_4 = $_POST['f_6_3_2_4']; 
	$f_6_3_2_desc = $_POST['f_6_3_2_desc']; 
	$f_7 = $_POST['f_7']; 
	$f_7_4 = $_POST['f_7_4']; 
	...
	mysqli_query($con,"INSERT INTO evaluation1_infra 
		(project_id, 
		f_1, 
		f_1_desc, 
		f_1_1, 
...
$getlast_id = mysqli_query($con,"SELECT id FROM evaluation1_infra ORDER BY id DESC limit 1");
