            ...
            <div class="row">
                ...
                <form id="submit_evaluation2" enctype="multipart/form-data" method="POST">
                            ...
                            <table class="table" id="checklist" border="1"
                                ...
                                <tbody id="translist">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center> <?=$value['f_3_1_4']?> </center>
                                        </td>
                                        <td>
                                           <?=$value['f_3_1_desc'] == 0 ? 'checked':''?> 
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <center> <?=$value['total_score16']?> </center>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <center> <?=$value['total_score17']?> </center>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <center> <?=$value['alltotal_score']?> </center>
                                        </td>
                                        <td></td>
                                    </tr>
                                </tbody>
                    ...
                    <di class="form-group col-md-3">
                        <label for="">Attribution: Php <?=number_format($value['attribution'],2)?></label> 
                        </div>
                    <div class="col-md-12">
